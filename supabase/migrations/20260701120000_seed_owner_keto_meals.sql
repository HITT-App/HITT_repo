-- Auto-generated by scripts/import_owner_meals.ts (keto category only).
-- Seeds the keto branch of the owner meal library.
-- Idempotent: re-running this seed replaces the keto rows only, leaving the
-- other owner categories (lose_weight / gain_weight / build_muscle / recovery)
-- untouched.
