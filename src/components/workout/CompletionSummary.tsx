...
export function CompletionSummary({
  ...
  // Auto-generate AI summary image on mount
  useEffect(() => {
    ...
    const generate = async () => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          // Fallback to canvas card
          const dataUrl = effectiveMapRef.current
            ? await generateMapCard(effectiveMapRef.current, activityTitle, stats)
            : await generateStatsCard(activityTitle, activityType || 'workout', stats, null);
          setGenProgress(100);
