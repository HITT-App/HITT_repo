...
export function CompletionSummary({
  ...
  // Auto-generate a default share card on mount
  useEffect(() => {
    if (autoGenerated.current || isGenerating || generatedImageUrl) return;
    ...
    const generate = async () => {
      ...
      try {
        ...
        // Silent fail — user can still pick a style manually
      } finally {
