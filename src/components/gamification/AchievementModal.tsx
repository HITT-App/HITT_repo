  ...
  return (
    <Dialog open={!!achievement} onOpenChange={() => onClose()}>
      <DialogContent className="sm:max-w-[340px] p-0 border-0 bg-transparent shadow-none">
        <div className="bg-card rounded-3xl p-8 text-center relative overflow-hidden">
          {/* Confetti dots */}
          ...
          {/* Icon */}
          <div
            className={`relative w-32 h-32 mx-auto mb-6 transition-transform duration-500 ${
          ...
          >
            ...
            <div className={`absolute inset-4 bg-gradient-to-br ${gradient} rounded-full flex items-center justify-center`}>
          ...
          <p className="text-muted-foreground mb-4">{achievement.subtitle}</p>

          {/* Value */}
          <div className="bg-secondary rounded-2xl py-4 px-6 mb-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button
              variant="ghost"
              className="w-full rounded-xl py-4 text-primary"
              onClick={onClose}
            >
              Share Achievement
            </Button>
